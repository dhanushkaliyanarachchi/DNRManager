<%@ Page Title="" Language="C#" MasterPageFile="~/DNR_Manager.Master" AutoEventWireup="true" CodeBehind="ReconnectionDetails.aspx.cs" Inherits="DNR_Manager.WebForm8" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="margin-top: 50px; margin-left: 20px; margin-right: 02px; width: 1300px; height: 520px">
        ...
        <div class="row">
            <table class="table table-bordered" id ="ReconnectionDetails">
                <thead>
                    <tr>
                        <th>Account No</th>
                        <th>Walk Order</th>
    ...
    <script type="text/javascript">
        $('#btnGenerate').click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "ReconnectionDetails.aspx/getReportDetailsToUi",
        ...
        function Scuccess(response) {
            var json = response.d;
            var $table = $("#ReconnectionDetails");
            //var circleNo = $("#select option:selected").val().toString();
            $("#ReconnectionDetails tr:gt(0)").remove();
            $(json).each(function () {
                var tr = [];
                tr.push('<tr>');
                ...
                tr.push('</tr>');
                $('#ReconnectionDetails').append($(tr.join('')));
            });
        }
    </script>
