                ...
                <div class="row" style="margin-top: 20px">
                    <form class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <asp:TextBox ID="TextBox1" runat="server" class="form-control" OnTextChanged="TextBox1_TextChanged1" Type="phone" onkeypress="return NumberOnly()" onkeyup  ="validateOnkeyup(event)" MaxLength="10"></asp:TextBox>
                            </div>
                            <div class="col-sm-2">
            ...
            <div class="col-md-6">
                ...
                <table class="table table-bordered">
                    ...
                    <tr style="border: solid">
                        ...
                        <td><%:i %></td>
                        <%if(item.DisconnectedDate == DateTime.MinValue ){%>
                        <td>Update DC Details</td>
                        <%}
                        else{%>
                         <td><%: item.DisconnectedDate %></td>
                        <%}%>

                        <%if (item.ReconnectedDate == DateTime.MinValue)
                          {%>
                        <td></td>
                        <%}
                        else{%>
                        ...
                        <%if (item.MeterRemovedDate == DateTime.MinValue)
                          {%>
                        <td></td>
                        <%}
                        else{%>
                        ...
                        <%}%>
                        <%if (item.FinalizedDate == DateTime.MinValue)
                          {%>
                        <td></td>
                        <%}
                        else{%>
                         <td><%: item.FinalizedDate %></td>
                        <%}%>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <asp:TextBox ID="TextBoxPaymentDetailsAccountNo" runat="server" class="form-control" ReadOnly="true" Enabled="False" onkeypress="return NumberOnly()" MaxLength="10"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group">
                                <label for="AccountNo" class="col-sm-2 control-label" style="padding-left: -3px; padding-top: 0px">Account No:</label>
                                <div class="col-sm-10">
                                    <asp:TextBox ID="TextBoxAccountNo" runat="server" class="form-control" ReadOnly="false" Enabled="true" onkeypress="return NumberOnly()" MaxLength="10"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<script type ="text/javascript">
    ...
    <script type ="text/javascript">
        function validateOnkeyup(event) {
            ...
            $('#<%=TextBox2.ClientID %>').text("");
            $('#<%=TextBoxWalkOrder.ClientID %>').val("");
            $('#<%=TextBoxDisconnectedBy.ClientID %>').val("");
            $('#<%=TextBoxDisconnectedDate.ClientID %>').val("");
            $('#<%=TextBoxTime.ClientID %>').val("");
            $('#<%=TextBoxStaus.ClientID %>').val("");
            
        }
    </script>

    <script type="text/javascript">
        function CallConfirmBox(acc) {
            if (confirm("There is a Reconnection which was Done with in last 30 Days. Do you want to add another Reconnection Detail?")) {
                debugger;
