<%@ Page Title="" Language="C#" MasterPageFile="~/DNR_Manager.Master" AutoEventWireup="true" CodeBehind="FinalizedAccountDetails.aspx.cs" Inherits="DNR_Manager.WebForm11" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="margin-top: 50px; margin-left: 20px; margin-right: 02px; width: 1300px; height: 520px">
        ...
        <div class="row">
            <table class="table table-bordered" id ="FinalizedDetailReportTable">
                <thead>
                    <tr>
                        <th>Account No</th>
                        <th>Walk Order</th>
    ...
    <script type="text/javascript">
        $('#btnGenerate').click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "FinalizedAccountDetails.aspx/getReportDetailsToUi",
        ...
        function Scuccess(response) {
            var json = response.d;
            var $table = $("#FinalizedDetailReportTable");
            //var circleNo = $("#select option:selected").val().toString();
            $("#FinalizedDetailReportTable tr:gt(0)").remove();
            $(json).each(function () {
                var tr = [];
                tr.push('<tr>');
                ...
                tr.push("<td>" + this.FinalizedDate + "</td>");
                tr.push('</tr>');
                $('#FinalizedDetailReportTable').append($(tr.join('')));
            });
        }
